...
const Login = ({ setActivePage }) => {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center p-4">
      <section className="flex w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-soft">
        {/* Left Side: Image */}
        <div className="hidden md:flex md:w-1/2 items-center justify-center bg-slate-50 border-r border-slate-100 p-6">
          <img
