  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <button onClick={() => setActivePage('cars')} disabled={company?.status !== 'verified'} className="rounded-2xl bg-slate-950 px-5 py-3 font-bold text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300">
          Add New Car
        </button>
      </div>
