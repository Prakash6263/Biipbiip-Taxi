...
import { Search, Building2, Phone, Mail, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      {paginatedCompanies.length === 0 ? (
        ...
        <div className="card card-table p-2">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 px-6 py-4">
            <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider">Display Company List</h3>
              ...
              <tbody>
                {paginatedCompanies.map((company) => (
                  <tr key={company.id} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="align-middle font-semibold text-slate-700">{company.ownerName}</td>
                    <td className="align-middle text-slate-600 font-medium">
